...
class TipKorisnikaPolicy
{
    ...
    {
        return $user->can('view TipKorisnika');
    }
    ...
    {
        return $user->can('show TipKorisnika');
    }
    ...
    {
        return $user->can('create TipKorisnika');
    }
    ...
    {
        return $user->can('update TipKorisnika');
    }
    ...
    {
        return $user->can('delete TipKorisnika');
    }
