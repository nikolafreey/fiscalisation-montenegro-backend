...
class CreateRacuniTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('racuni', function (Blueprint $table) {
            ...
            $table->decimal('ukupna_cijena_bez_pdv', 20, 10)->default(0);
            $table->decimal('ukupna_cijena_bez_pdv_popust', 20, 10)->default(0);
            $table->decimal('ukupna_cijena_sa_pdv', 20, 10)->default(0);
            $table->decimal('ukupna_cijena_sa_pdv_popust', 20, 10)->default(0);
            $table->decimal('ukupan_iznos_pdv', 20, 10)->default(0);
