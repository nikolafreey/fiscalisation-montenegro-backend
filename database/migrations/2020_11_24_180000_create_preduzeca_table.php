...
class CreatePreduzecaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('preduzeca', function (Blueprint $table) {
            ...
            $table->string('twitter_username', 100)->nullable()->unique();
            $table->string('instagram_username', 100)->nullable()->unique();
            $table->string('facebook_username', 100)->nullable()->unique();
            $table->string('skype_username', 100)->nullable()->unique();
